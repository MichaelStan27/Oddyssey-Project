...
@section('content')
    <div class="container mx-auto mb-20">
        <div class="m-auto w-1/2 bg-white rounded-md p-5">
            ...
            <form action="{{ route('manage-game.create') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-5">
                ...
                <div class="mb-2">
                    ...
                    <textarea name="desc" id="desc" rows="8"
                        class="border-gray-200 rounded-md border-2 w-full p-2 outline-none focus:border-purple-300">{{ old('desc') }}</textarea>
                    @error('desc')
